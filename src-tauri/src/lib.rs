...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::sc_track_detail,
            commands::sc_track_likers,
            commands::sc_track_reposters,
            commands::sc_track_in_playlists,
            commands::sc_track_download_url,
            commands::sc_waveform,
            commands::sc_track_comments,
            commands::sc_post_comment,
            commands::sc_delete_comment,
            commands::sc_conversations,
            commands::sc_unread_messages,
            commands::sc_conversation,
            commands::sc_send_message,
            commands::sc_mark_conversation,
            commands::sc_delete_conversation,
            commands::sc_notifications,
            commands::sc_get_albums,
            commands::sc_get_top_tracks,
            commands::sc_get_spotlight,
            commands::sc_get_reposts,
            commands::sc_get_related_artists,
            commands::sc_tag_tracks,
            commands::sc_resolve,
            commands::sc_repost_track,
